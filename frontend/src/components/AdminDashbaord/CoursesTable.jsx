      ...
      <table className="min-w-full whitespace-nowrap text-left">
        ...
        <tbody>
          ...
          {courses.map((course, idx) => (
            <tr key={idx} className="border-b last:border-0 hover:bg-gray-100/10 transition">
              <td className="px-6 py-4 text-light-text/70 dark:text-dark-text/70">{course.title}</td>
              <td className="px-6 py-4 text-light-text/70 dark:text-dark-text/70">{course.description}</td>
