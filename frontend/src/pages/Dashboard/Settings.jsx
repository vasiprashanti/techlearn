      ...
      <div className="space-y-8">
        ...
        >
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <span className="dashboard-inner-surface inline-flex items-center gap-2 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-widest text-[#4f719c] dark:text-[#8ac7f3]">
              Mock Settings
            </span>
          </div>
        </motion.section>
