...
useEffect(() => {
  ...
  className="h-10 px-3 text-xs rounded-lg border border-black/10 dark:border-white/10 bg-white/60 dark:bg-white/5 text-slate-700 dark:text-white outline-none"
>
...
<select
  ...
  disabled={!sortBy}
  className="h-10 px-3 text-xs rounded-lg border border-black/10 dark:border-white/10 bg-white/60 dark:bg-white/5 text-slate-700 dark:text-white outline-none disabled:opacity-50"
>
          ...
          <div className="rounded-2xl border border-black/10 dark:border-white/10 overflow-hidden bg-white/70 dark:bg-[#0b1b38] shadow-sm">
            ...
            {loading ? (
              ...
              jobs.map((job) => (
                <div
                  key={job.id}
                  className="grid grid-cols-1 md:grid-cols-[150px_1.2fr_1.5fr_1fr_1fr_1.2fr_110px_70px] gap-3 md:gap-4 px-5 py-5 border-b border-black/5 dark:border-white/10 last:border-b-0 hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition-colors"
                >

                  {/* JID */}
                  <div>
                    <span className="block whitespace-nowrap text-xs font-semibold text-[#3C83F6] dark:text-blue-300">
                      {job.JID || job.jid || job.id}
                    </span>
                  </div>
  ...
  <div className="flex items-center justify-between mt-5 px-1">
    ...
    <div className="flex items-center gap-2">
      <button
        ...
        className="px-3 py-2 rounded-lg border border-black/10 dark:border-white/10 text-xs font-semibold text-slate-600 dark:text-slate-300 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-black/5 dark:hover:bg-white/5"
      >
        Previous
      </button>
